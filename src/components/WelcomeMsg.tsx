    ...
    <div className="fixed inset-0 bg-black/75 flex items-center justify-center z-50">
      <div className="bg-white text-black rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl">
        ...
        <p className="text-gray-500 mb-6 text-sm">
          This is a Pokemon card manager. You can browse all cards, view
          details, and simulate battles.
        </p>

        <div className="bg-gray-100 rounded-xl p-4 mb-6 grid gap-6">
          ...
          <p className="text-xs text-gray-500 mt-4">
            Disclaimer: credentials exposed for challenge evaluation purposes
            only 😅
          </p>
        </div>
